...
namespace SFCS0020_Enum
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var size in Enum.GetValues(typeof(Size)))  //...☎0010.107p.
            {
                Console.WriteLine("{0,10} : {1:C}", size, price[(int)size]); //...☎0020.045p.Currency.
            }
